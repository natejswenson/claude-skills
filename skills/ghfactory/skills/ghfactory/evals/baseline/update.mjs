 ...
 * press's version, so freezing it would make every press release break ghfactory's
 * CI for a change that altered nothing ghfactory emits. The marker format is press's
