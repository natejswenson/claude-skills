...
- Optional, for the radar: an authenticated Codex CLI for --backend codex, or the [claude CLI](https://docs.claude.com) for the legacy default. Codex radar needs no Claude CLI, Claude authentication, o… `skills/ghostwriter-x/README.md:104`
...
- bash scripts/install_radar.sh --backend codex `skills/ghostwriter-x/README.md:195`
- bash scripts/release_radar.sh --backend codex `skills/ghostwriter-x/README.md:196`
- python3 scripts/release_radar_runtime.py discover `skills/ghostwriter-x/README.md:197`
...
- Ships module scripts/release_radar_fetch.py. `skills/ghostwriter-x/skills/ghostwriter-x/scripts/release_radar_fetch.py:1`
- Ships module scripts/release_radar_runtime.py. `skills/ghostwriter-x/skills/ghostwriter-x/scripts/release_radar_runtime.py:1`
