...
- runtime presentation contract — The terminal and transcript rules are shared behavior, not consumer-owned prose. Keeping one runtime contract prevents every skill from drifting when the interface cha… `skills/press/skills/press/skill-invariants.json:26`
