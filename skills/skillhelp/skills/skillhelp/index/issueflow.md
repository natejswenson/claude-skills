...
- node evals/harness.mjs baseline --ref <commit> --out <new-output-directory> `skills/issueflow/README.md:285`
- node evals/harness.mjs run --mode offline --out <different-new-output-directory> `skills/issueflow/README.md:286`
- node evals/harness.mjs compare --baseline <baseline-directory>/report.json --candidate <candidate-directory>/report.json `skills/issueflow/README.md:287`
...
- the red team is the gate, and it is a dispatched subagent — never you — The plan's gate must have the same independence a human would: a reviewer that shares the orchestrator's context has already be… `skills/issueflow/skills/issueflow/skill-invariants.json:1`
