 ...
 * hash — forge only decides *which* workflow gets one and what it says. Copying
 ...
 * publish before forge's own tests can run — makes the two skills unlandable
 * together.
 */
 ...
 * and a workflow forge generated lives in a repo press has never heard of. Same
