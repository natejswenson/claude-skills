...
nobody can argue with is the one the skill wrote down itself, so eval never
...
- Prose that motivates, illustrates or reassures. "skillfactory exists because…" is
