 ...
 * smith's question budget achievable: a name collision, the required-check set
 ...
 * trusts. A generated workflow must never carry a SHA smith remembered: a
 * frozen pin table starts rotting the day it ships, and a hallucinated one is
 * the exact defect forge's rung 0 exists to catch. Reading the repo's own
