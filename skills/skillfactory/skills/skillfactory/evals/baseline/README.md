...
| [`repocount`](skills/repocount) | ![repocount](https://img.shields.io/github/v/tag/natejswenson/claude-skills?filter=repocount-v*&label=&sort=semver&color=blue) | `/repocount` | Node | Count what a repository owes you — open PRs, stale branches, unreleased commits — as one table. |
...
ln -sfn "$PWD/skills/repocount/skills/repocount" ~/.claude/skills/repocount
```
</details>
