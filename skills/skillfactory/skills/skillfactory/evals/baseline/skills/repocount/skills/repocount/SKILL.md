...
# /repocount — Count what a repository owes you — open PRs, stale branches, unreleased commits — as one table

You are running the **repocount** skill.

**Announce at start:** "I'm using the repocount skill — Count what a repository owes you — open PRs, stale branches, unreleased commits — as one table."
...
|---|---|
| read the repo's counts | `node scripts/repocount.js count` |
| resolve the release convention | `node scripts/repocount.js detect` |
...
| Path | Is |
|---|---|
| `scripts/repocount.js` | the CLI: `detect`, `count` |
| `references/anatomy.md` | the fixed shape of a repocount report |
