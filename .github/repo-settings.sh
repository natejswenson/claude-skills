...
gh api -X PUT "repos/$REPO/branches/main/protection" --input - >/dev/null <<'JSON'
{
  "required_status_checks": {
    "strict": false,
    "contexts": ["ci / devlog", "ci / resume", "ci / ghostwriter", "ci / ghostwriter-x", "ci / github-stats", "ci / shipflow", "ci / city-report", "ci / press", "ci / ghfactory", "ci / skillfactory", "ci / eval", "ci / release", "ci / pluginsync", "ci / issueflow", "ci / shipreport", "ci / gmailtriage", "ci / skillhelp", "ci / brandreport", "ci / netwatch", "ci / appletv"]
  },
  "enforce_admins": false,
